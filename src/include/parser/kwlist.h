...
PG_KEYWORD("algebraic", ALGEBRAIC, RESERVED_KEYWORD)
PG_KEYWORD("algorithm", ALGORITHM, RESERVED_KEYWORD)
...
PG_KEYWORD("bounded", BOUNDED, RESERVED_KEYWORD)
...
PG_KEYWORD("crisp", CRISP, RESERVED_KEYWORD)
...
PG_KEYWORD("distance", DISTANCE, RESERVED_KEYWORD)
...
PG_KEYWORD("drastic", DRASTIC, RESERVED_KEYWORD)
...
PG_KEYWORD("equidistant", EQUIDISTANT, UNRESERVED_KEYWORD)
PG_KEYWORD("equifrequent", EQUIFREQUENT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("feature", FEATURE_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("marks", MARKS, RESERVED_KEYWORD)
PG_KEYWORD("match", MATCH, UNRESERVED_KEYWORD)
PG_KEYWORD("materialized", MATERIALIZED, UNRESERVED_KEYWORD)
PG_KEYWORD("max", MAX_P, UNRESERVED_KEYWORD)
PG_KEYWORD("maxvalue", MAXVALUE, UNRESERVED_KEYWORD)
PG_KEYWORD("minkowski", MINKOWSKI, RESERVED_KEYWORD)
...
PG_KEYWORD("normalization", NORMALIZATION, RESERVED_KEYWORD)
...
PG_KEYWORD("precompute", PRECOMPUTE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sugeno", SUGENO, RESERVED_KEYWORD)
...
PG_KEYWORD("va", VA, UNRESERVED_KEYWORD)
...
PG_KEYWORD("weighted", WEIGHTED, RESERVED_KEYWORD)
...
PG_KEYWORD("yager", YAGER, RESERVED_KEYWORD)
